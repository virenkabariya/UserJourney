    ...
    public class EmailService : IEmailService
    {
        ...
        public async Task<bool> SendEmailAsync(List<string> to, List<string> cc, string subject, string templateName, Dictionary<string, string> values, byte[] attachment = null, string attachmentName = null)
        {
            try
            {
                ...
                string masterTemplateFullPath = Path.Combine(templatePath, string.Format("{0}.html", EmailTemplateFileName.MasterEmailTemplate.ToString())); 
                ...
                emailMessage.From.Add(new MailboxAddress("UserJourney", "keval.jarsania@tatvasoft.com"));
